...
<html>
<head>
<link ref="https://cdn.jsdelivr.net/npm/bootstrap@4.6.1/dist/css/bootstrap.min.css" rel="stylesheet">
</head>
<title>
    GELAR</title>
<body>
<nav class="navbar navbar-dark bg-dark">
      <span class="navbar_brand mb-0 h1">GELAR</span>
    </div>
  </nav>
<div class="container">
    <br>
    ...
    <table class="my-3 table table-bordered">
        ...
        <tbody>
            <tr>
                ...
                $data['id_peserta']; ?>" class="btn btn-danger" role="button">Delete</a>
         </td>
        </tr>
    </tbody>
<?php 
